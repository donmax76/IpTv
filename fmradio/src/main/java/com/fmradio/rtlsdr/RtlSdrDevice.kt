...
class RtlSdrDevice(private val context: Context) {
    ...
    companion object {
        ...
        // Full known_devices list from librtlsdr. FC0013 sticks in particular
        // ship under many brands (Terratec, Dexatek, MSI, SVEON, ...) that the
        // short list previously missed.
        private val SUPPORTED_DEVICES = listOf(
            ...
            Pair(0x1B80, 0xD3A9), // Nooelec (alt PID)
        )
