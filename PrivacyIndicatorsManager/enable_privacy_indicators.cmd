...
REM enable_privacy_indicators.cmd
REM Windows-da gizlilik gostergelerinin aktivlesdirilmesi
REM
...
echo.
echo ========================================
echo Gizlilik gostergelerinin aktivlesdirilmesi
echo ========================================
echo.
...
REM Reestr deyeri hex formatinda ola biler (0x0), ona gore hem decimal hem hex yoxlayiriq
...
if "!VALUE_MATCH!"=="True" (
    echo.
    echo [OK] Gosterge ugurla aktivlesdirildi!
    echo.
